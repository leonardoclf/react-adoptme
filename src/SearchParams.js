...
const SearchParams = () => {
  ...
  // useState é somente um container. 
...
/*
    não pode chamar de class porque class é reservado
    for é palavra reservada -> htmlFor

    {} - javascript expression

    Em regra, não coloca o index porque o index não fecha.
*/
